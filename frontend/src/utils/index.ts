...
import { Question, FormResponse, ValidationResult, ProgressState } from '../types';

/**
 * Form validation utilities
 */
export const validateResponse = (question: Question, value: any): ValidationResult => {
 ...
 */
export const calculateProgress = (responses: FormResponse, questions: Question[]): ProgressState => {
